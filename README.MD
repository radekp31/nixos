...
- [ ] Fix nixpkgs.config warning with home-manager
- [ ] Fix disko module import in deployment configuration
- [ ] Ensure all configurations build successfully with `nix flake check`
