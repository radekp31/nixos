...
#      rnix-lsp
 ...
 systemd.user.services.git-backup = {
    ...
    Service = {
      ...
      ExecStart = "${pkgs.bash}/bin/bash -c 'eval $(${pkgs.openssh}/bin/ssh-agent) && /home/radekp/.dotfiles/backup.sh && ${pkgs.openssh}/bin/ssh-agent -k'";
      Environment = [
        "SSH=${pkgs.openssh}/bin/ssh"
        "GIT=${pkgs.git}/bin/git"
        "HOME=/home/radekp"  # Ensure HOME is set
      ];
    };
    Install = {
